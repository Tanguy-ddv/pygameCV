...
def test_circle(save_dir):
    ...
    circle(img, (100, 200), 100, (255, 255, 0, 255), 50, True)
    ...
    circle(img_alpha, (100, 200), 100, (255, 255, 0, 255), 50, True)
...
def test_ellipse(save_dir):
    img, img_alpha = init(save_dir)
    ellipse(img, (100, 200), 100, 100, (255, 255, 0, 255), 50, True, 0)
    ...
    ellipse(img_alpha, (100, 200), 100, 100, (255, 255, 0, 255), 50, True, 0)
